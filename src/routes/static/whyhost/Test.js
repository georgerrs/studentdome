        ...
        return (
            <div>
                <div className={s.TopBannerHeader}>
                    <div className={s.topImageBanner} style={{ backgroundImage: `url(${Image})` }} />
                    <div className={s.bannerText}>
                        <Col xs={12} sm={8} md={8} lg={8} className={s.noPadding}>
                            <h1 className={s.bannerTitle}><FormattedMessage {...messages.topBannerTitle} /></h1>
                            <div>
                                <Button className={cx(s.button)} onClick={this.handleClick}>
                                    <FormattedMessage {...messages.becomeAHost} />
                                </Button>
                                <Link className={cx(s.button, s.btnPrimaryBorder, s.linkButton, s.btnRight)} activeClass={s.active} to="test1" spy={true} smooth={true}>
